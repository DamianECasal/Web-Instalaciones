...
const motives = [
        ...
        },
        {
            ...
            desc:  ["En caso de que la orden pertenezca al segmento Pymes: Reportar con mesa de despacho correspondiente ya que por proceso no permite la modificación en linea.",
                    "En caso de que la orden pertenezca al segmento Residencial: Reportar con mesa de despacho correspondiente ya que si el domicilio real se encuentra mayor a 1km no se puede realizar la modificación de la misma en línea.",
        ...
        },
        {
            ...
            desc: ["Se debe solicitar al Analista (Referente de la plaza) para su utilizacion:",
                    "Se solicitara unicamente cuando la contratista, no pueda/logre asumir las tareas asignadas debido a las ausencias de los técnicos"],
